<template>
  <div>
    <div id="fullpage">
        ...
        >
          <CarouselItem v-for="(item, index) in picList" :key="index">
            ...
            >
              <a
                v-show="
                  item.linkUrl && item.linkUrl != ' ' && item.linkUrl != '1'
                "
      ...
      <div class="section" id="page5" v-if="false">
        ...
        <ul class="download">
          ...
          <li class="wrapper">
            ...
            <div class="abstract">
              <div class="image">
                <Icon type="logo-apple" size="30" color="#fff" />
              </div>
              <div class="content">
                <span>iPhone</span>
              </div>
    ...
    <div id="onlineservice">
      <a
        href="http://kefu.caymanex.pro:80/im/text/15FwEk.html"
        target="_blank"
      ></a>
    </div>
  </div>
  ...
  methods: {
    ...
    move() {
      ...
      if (this.cal) {
        ...
        let l = this.list[0] && this.list[0].cloneNode(true);
        l && this.cal.appendChild(l);
        this.startMove();
      }
    },
    startMove() {
    ...
    addClass(index) {
      ...
      let currentCoin = this.indexBtn[index]["text"];

      this.dataIndex = this.coins[currentCoin];
