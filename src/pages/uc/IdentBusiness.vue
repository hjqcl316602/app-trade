 ...
 * @LastEditTime: 2019-08-14 12:00:35
...
<template>
  <div class="identbusiness" style=" padding: 81px;padding-top: 80px;">
    ...
    <Modal v-model="modal_read" :mask-closable="false">
      <!-- 如何申请成为商家 -->
      <p slot="header">
    ...
    <Modal v-model="modal_apply" :mask-closable="false">
      <p slot="header"></p>
      <div class="apply-content">
        ...
        <Form class="apply-form" :model="apply_form" label-position="top">
          ...
          <Row>
            <Col span="8">
            <Upload type="drag" ref="upload1" :on-success="assetHandleSuccess" :headers="uploadHeaders" :action="image.compress" :on-remove="assetRemove">
            ...
            <Col span="8">
            <Upload type="drag" ref="upload2" :on-success="tradeHandleSuccess" :headers="uploadHeaders" :action="image.compress" :on-remove="tradeRemove">
              <span style="line-height: 100px;font-size: 50px;color:#ccc;">+</span>
    ...
    <Modal v-model="modal_return" @on-ok="returnAudit" :mask-closable="false">
...
export default {
  ...
  methods: {
    ...
    assetHandleSuccess(res, file, fileList) {
      ...
      this.apply_form.assetData = res.data['url'];
      this.assetImg = res.data['url'];
    },
    tradeHandleSuccess(res, file, fileList) {
      this.$refs.upload2.fileList = [fileList[fileList.length - 1]];
      this.apply_form.tradeData = res.data['url'];
      this.tradeImg = res.data['url'];
    },
