module.exports = {
    ...
    uc: {
        ...
        account: {
            ...
            bankaccountmsg: '开户银行不能为空，请正确输入银行卡号！',
    ...
    description: {
        ...
        message5: '国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    },
    footer: {
        wechatkefu: "微信客服",
        notice: '平台公告',
    ...
    index: {
        ...
        fenpeijizhi: '关于平台收入分配机制的说明',
        jiangli_jihua: "邀请挖矿奖励计划",
        friend_fanhuan: "邀请好友、赚取额外手续费返还"
    },
    plate: {
        title: "平台收入分配方案 (BHB 持有者权益)",
        content1: "正如白皮书所描述的，会拿出平台的80% (扣除税费后) 的收入分配给平台持有者，20%的收入用来支持平台的研发及运营。",
