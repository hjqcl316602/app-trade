module.exports = {
    ...
    otc: {
        ...
        publishad: {
            ...
            warning8: 'The minimum transaction amount must be greater than or equal to 10!',
    ...
    uc: {
        ...
        identity: {
            ...
            become: "Become TTM Certified Business and enjoy more transaction privileges",
    ...
    description: {
        ...
        // message3: 'TTM Exchange supports 10,00 transactions per second, giving users a hearty transaction experience',
        message4: 'Multi-terminal APP, easily traded between',
        message5: 'TTM international digital encryption asset trading platform mobile client, focusing on palm trading experience',
    },
    footer: {
    ...
    index: {
        ...
        BHBregister: "TTM account registration",
        ...
        fenpeijizhi: 'A description of the TTM income distribution mechanism',
    ...
    plate: {
        ...
        content1: "As described in the white paper, TTM will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to BHB holders, and 20% of revenue is used to support R & D and operation of the platform.",
