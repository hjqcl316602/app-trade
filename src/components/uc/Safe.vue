 ...
 * @LastEditTime: 2019-09-02 17:21:21
              ...
              <div class="user-face user-avatar-public">
                <span class="user-avatar-in">
                  <template v-if="member.avatar">
                    <img :src="member.avatar" alt="" style="max-height:100%;max-width:100%">
                  </template>
                  <template v-else>
                    {{ usernameS }}
                  </template>
            ...
            <div class="account-in">
              ...
              <div class="account-item">
                <div class="account-item-in">
                  ...
                  <p v-else-if="user.realVerified == 0 && user.realAuditing == 0 && user.realNameRejectReason != null" class="bankInfo" style="color: #f0a70a;">审核未通过{{ user.realNameRejectReason ? '：' + user.realNameRejectReason : '' }}，请重试。</p>
                  ...
                  <div class="detail-list" style="width: 100%;">
                    <Form ref="formValidate6" :model="formValidate6" :rules="ruleValidate" :label-width="85" style="text-align:center;">
                      ...
                      <FormItem :label="$t('uc.safe.realname')" prop="realName">
                        <Input v-model="formValidate6.realName" size="large" autocomplete="off"></Input>
                      </FormItem>
                      <!-- 身份证号 -->
                      <FormItem :label="$t('uc.safe.idcard')" prop="idCard">
                        <Input v-model="formValidate6.idCard" size="large" autocomplete="off"></Input>
                      </FormItem>
                      <div style="height:350px;">
                        <Col span="8">
                          ...
                          <div class="acc_sc">
                            <Upload ref="upload1" :before-upload="beforeUpload" :on-success="frontHandleSuccess" :headers="uploadHeaders" :action="image.compress">
                        ...
                        <Col span="8">
                          ...
                          <div class="acc_sc">
                            <Upload ref="upload2" :before-upload="beforeUpload" :on-success="backHandleSuccess" :headers="uploadHeaders" :action="image.compress">
                              <Button icon="ios-cloud-upload-outline">{{ $t('uc.safe.upload') }}</Button>
                            </Upload>
                          </div>
                        </Col>
                        <Col span="8">
                          ...
                          <div class="acc_sc">
                            <Upload ref="upload3" :before-upload="beforeUpload" :on-success="handHandleSuccess" :headers="uploadHeaders" :action="image.compress">
                              <Button icon="ios-cloud-upload-outline">{{ $t('uc.safe.upload') }}</Button>
                            </Upload>
                          </div>
                        </Col>
                  ...
                  <div class="detail-list">
                    <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="110">
                      ...
                      <FormItem :label="$t('uc.safe.email')" prop="mail">
                        <Input v-model="formValidate2.mail" size="large" autocomplete="off"></Input>
                      </FormItem>
                      <!-- 登录密码 -->
                      <FormItem :label="$t('uc.safe.loginpwd')" prop="password">
                        <Input v-model="formValidate2.password" size="large" type="password" autocomplete="off"></Input>
                      </FormItem>
                      <!-- 邮箱验证码 -->
                      <FormItem :label="$t('uc.safe.emailcode')" prop="vailCode1">
                        <Input v-model="formValidate2.vailCode1" size="large" autocomplete="off">
                  ...
                  <div class="detail-list">
                    <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate" :label-width="110">
                      ...
                      <FormItem :label="$t('uc.safe.phone')" prop="mobile">
                        <Input v-model="formValidate3.mobile" size="large" autocomplete="off"></Input>
                      </FormItem>
                      <!-- 登录密码 -->
                      <FormItem :label="$t('uc.safe.loginpwd')" prop="password">
                        <Input v-model="formValidate3.password" size="large" type="password" autocomplete="off"></Input>
                      </FormItem>
                      <!-- 手机验证码 -->
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //uploadUrl: 'http://103.91.217.67/res/upload/image/compress.do',
  ...
  created() {
    this.getMember();
    this.choseItem = Number(this.$route.query.type || 0);
